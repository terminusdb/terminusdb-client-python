...
class ConnectionCapabilities:
    ...
    def _extract_user_info(self, capabilities):
        ...
        info["roles"] = self._multiple_rdf_objects(
            capabilities["system:role"], "system:Role"
        )
        return info
    ...
    def _extract_user_role(self, jrole):
        ...
        nrole["capabilities"] = self._multiple_rdf_objects(
            jrole["system:capability"], "system:Capability"
        )
        return nrole
    ...
    def _extract_role_capability(self, jcap):
        ...
        nrole["resources"] = self._extract_capability_resources(
            jcap["system:capability_scope"]
        )
        return nrole
