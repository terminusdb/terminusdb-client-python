...
dbrecs = [
    ...
    {'db': 'adsasasddsa', 'account': 'admin', 'title': 'admin|adsasasddsa', 'description': 'asdsadsda'}, 
    {'db': 'blah', 'account': 'admin', 'title': 'admin|blah', 'description': 'adfadf'}, 
    {'db': 'daassd', 'account': 'admin', 'title': 'admin|daassd', 'description': 'asdasdsd'}, 
    {'db': 'dassadds', 'account': 'admin', 'title': 'admin|dassadds', 'description': 'asdsdsad'}, 
    {'db': 'ddd', 'account': 'admin', 'title': 'admin|ddd', 'description': 'ddds'}, 
    {'db': 'ffff', 'account': 'admin', 'title': 'admin|ffff', 'description': 'fffff'}, 
    {'db': 'fffffff', 'account': 'admin', 'title': 'admin|fffffff', 'description': 'fff'},
    {'db': 'ggggggggg', 'account': 'admin', 'title': 'admin|ggggggggg', 'description': 'gg'},
    {'db': 'twretwert', 'account': 'admin', 'title': 'admin|twretwert', 'description': 'adfadf'}, 
    {'db': 'terminus', 'account': '', 'title': 'Master Database', 'description': 'The master database contains the meta-data about databases, users and roles'}
]
