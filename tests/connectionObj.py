snapCapabilitiesObj= {
      ...
      "terminus:authority": {
    	...
    	{
    	  "@id":"terminus:commit_read_access",
    	  "@type":"terminus:DBAction"
    	},
    	{
    	  "@id":"terminus:commit_write_access",
    	  "@type":"terminus:DBAction"
    	},
    	{
    	...
    	{
    	  "@id":"terminus:inference_read_access",
    	  "@type":"terminus:DBAction"
    	},
    	{
    	...
    	{
    	  "@id":"terminus:instance_read_access",
    	  "@type":"terminus:DBAction"
    	},
    	{
    	  "@id":"terminus:instance_write_access",
    	  "@type":"terminus:DBAction"
    	},
    	{"@id":"terminus:manage", "@type":"terminus:DBAction"},
    	{
    	  "@id":"terminus:meta_read_access",
    	  "@type":"terminus:DBAction"
    	},
    	{
    	  "@id":"terminus:meta_write_access",
    	  "@type":"terminus:DBAction"
    	},
    	{"@id":"terminus:push", "@type":"terminus:DBAction"},
    	{"@id":"terminus:rebase", "@type":"terminus:DBAction"},
    	{
    	  "@id":"terminus:schema_read_access",
    	  "@type":"terminus:DBAction"
    	},
    	{
    	  "@id":"terminus:schema_write_access",
    	  "@type":"terminus:DBAction"
    	}
          ],
    	...
    	},
    	{
    	  ...
    	  "terminus:resource_name": {"@type":"xsd:string", "@value":"admin|adsasasddsa"}
    	},
    	{
